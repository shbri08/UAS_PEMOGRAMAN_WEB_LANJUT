    ...
    <form action="<?php echo e(route('users.update', $users->id)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
                            ...
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="identity_card_number"
                                        ...
                                        value="<?php echo e(old('identity_card_number', $users->identity_card_number)); ?>">
                                </div>
                            </div>
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="phone" id="phone"
                                        value="<?php echo e(old('phone', $users->phone)); ?>">
                                </div>
                            </div>
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="gender" id="gender" value="1"
                                        <?php if($users->gender == '1'): ?> checked <?php endif; ?>> Pria
                                    <input type="radio" name="gender" id="gender" value="0"
                                        <?php if($users->gender == '0'): ?> checked <?php endif; ?>> Wanita
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="address">Alamat</label>
                            <textarea type="address" class="form-control" name="address" id="address" rows="2"><?php echo e(old('address', $users->address)); ?></textarea>
                        </div>
                        <div class="row">
                                    ...
                                    <select class="form-control" name="province_id" id="province_id">
                                        ...
                                        <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($province->code); ?>"
                                                <?php if($province->code == $users->province_id): ?> selected <?php endif; ?>>
                                    ...
                                    <select name="city_id" id="city_id" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($city->code); ?>"
                                                <?php if($city->code == $users->city_id): ?> selected <?php endif; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="district_id" id="district_id" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($district->code); ?>"
                                                <?php if($district->code == $users->district_id): ?> selected <?php endif; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="village_id" id="village_id" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $villages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $village): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($village->code); ?>"
                                                <?php if($village->code == $users->village_id): ?> selected <?php endif; ?>>
                            ...
                            <div class="col col-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="rt" id="rt"
                                        value="<?php echo e(old('rt', $users->rt)); ?>">
                                </div>
                            </div>
                            <div class="col col-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="rw" id="rw"
                                        value="<?php echo e(old('rw', $users->rw)); ?>">
                                </div>
                            </div>
                            <div class="col col-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="postcode" id="postcode"
                                        value="<?php echo e(old('postcode', $users->postcode)); ?>" placeholder="isikan angka saja">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col col-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <?php if($users->profile_image): ?>
                                        <p>
                                            <img src="<?php echo e(Storage::url('images/users/' . $users->profile_image)); ?>"
            ...
            <div class="card-footer">
                ...
                <a href="<?php echo e(route('users.index')); ?>" name="reset" class="btn btn-dark">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MyFolder\Kuliah\pemweb-lanjut\lara-starter\resources\views/backend/user/edit.blade.php ENDPATH**/ ?>