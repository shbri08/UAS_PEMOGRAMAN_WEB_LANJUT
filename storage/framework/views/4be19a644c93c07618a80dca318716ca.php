                        ...
                        <?php $__currentLoopData = $latest_posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latestPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col">
                                <div class="card border-0 bg-light-subtle rounded-3 shadow">
                                    <a href="<?php echo e(route('posts.show', ['seotitle' => $latestPost->seotitle])); ?>">
                                            <img src="<?php echo e(asset('storage/images/posts/' . $latestPost->image)); ?>"
                                                class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Semester 4\Pemrograman Web Lanjut\UAS\Laravel\resources\views/frontend/posts/index.blade.php ENDPATH**/ ?>