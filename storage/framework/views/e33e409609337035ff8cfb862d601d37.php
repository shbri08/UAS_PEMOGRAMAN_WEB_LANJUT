                            ...
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="identity_card_number"
                                        id="identity_card_number" value="<?php echo e($users->identity_card_number); ?>">
                                </div>
                            </div>
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                            ...
                            <div class="col col-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="postcode" id="postcode"
                                        value="<?php echo e($users->postcode); ?>" placeholder="isikan angka saja">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Semester 4\Pemrograman Web Lanjut\UTS\Laravel\lara-starter\resources\views/backend/profile/edit.blade.php ENDPATH**/ ?>