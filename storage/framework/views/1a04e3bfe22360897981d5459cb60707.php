                ...
                <div class="tab-content p-0">
                    ...
                    <div class="chart tab-pane active" id="biodata">
                            ...
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="identity_card_number"
                                        id="identity_card_number" value="<?php echo e(old('identity_card_number')); ?>">
                                </div>
                            </div>
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="address" class="form-control" name="address" id="address" rows="2"><?php echo e(old('address')); ?></textarea>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="province_id" id="province_id">
                                        ...
                                        <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($province->code); ?>" onChange="tampilKota()">
                                                <?php echo e(ucwords(strtolower($province->name))); ?>
                            ...
                            <div class="col col-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password" id="password"
                                        value="<?php echo e(old('password')); ?>" required autocomplete="false">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MyFolder\Kuliah\pemweb-lanjut\lara-starter\resources\views/backend/user/create.blade.php ENDPATH**/ ?>