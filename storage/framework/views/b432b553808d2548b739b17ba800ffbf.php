                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a class="dropdown-item <?php echo e(request()->segment(3) == $category->seotitle ? 'link-primary' : 'link-secondary'); ?>"
                                    href="<?php echo e(route('posts.category', $category->seotitle)); ?>">
                ...
                <?php if(auth()->user()->hasRole('author')): ?>
                    <div class="dropdown text-end">
                        ...
                        <ul class="dropdown-menu text-small" >
                            ...
                            <li><a class="dropdown-item" href="<?php echo e(route('user-profile.edit', auth()->id())); ?>">Profile</a></li>
                            <li>
...
<?php /**PATH D:\Semester 4\Pemrograman Web Lanjut\UAS\Laravel\resources\views/frontend/layouts/navigation.blade.php ENDPATH**/ ?>