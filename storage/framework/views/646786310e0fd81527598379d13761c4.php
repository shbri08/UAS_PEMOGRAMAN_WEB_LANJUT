...
<?php $__env->startSection('content'); ?>
    <section id="latest-post">
        <div class="container mb-3 px-4">
            ...
            <form action="<?php echo e(route('author.posts.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                    <div class="card-body">
                        <?php if($errors->any()): ?>
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="meta_description" id="meta_description" value="<?php echo e(old('description')); ?>"
                                    rows="3"></textarea>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" value="<?php echo e(old('description')); ?>" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MyFolder\Kuliah\pemweb-lanjut\lara-starter\resources\views/frontend/author/posts/create.blade.php ENDPATH**/ ?>