                        ...
                        <?php $__currentLoopData = $post_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $postCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-6">
                                <div class="card border-0 bg-light rounded-4">
                                    <?php if($postCategory->featured_image && Storage::exists('images/posts/' . $postCategory->featured_image)): ?>
                                        <img src="<?php echo e(asset('storage/images/posts/' . $postCategory->featured_image)); ?>"
                                            class="card-img-top">
                                    <?php else: ?>
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <a href="<?php echo e(route('posts.show', ['slug' => $postCategory->slug])); ?>"
                                                class="text-decoration-none">
                                                <?php echo e(Str::limit($postCategory->title, 60)); ?>

                                            </a>
                                        </h5>
                                        <p class="card-text mt-3"><?php echo Str::limit($postCategory->description, 150); ?></p>
                                    </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MyFolder\Kuliah\pemweb-lanjut\lara-starter\resources\views/frontend/posts/category.blade.php ENDPATH**/ ?>