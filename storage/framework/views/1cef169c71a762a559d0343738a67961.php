                ...
                <div class="row g-0">
                    <div class="col-md-4">
                        <a href="<?php echo e(route('posts.show', ['slug' => $sidebarRecentPosts->slug])); ?>">
                            <?php if($sidebarRecentPosts->featured_image && Storage::exists('images/posts/' . $sidebarRecentPosts->featured_image)): ?>
                                <img src="<?php echo e(asset('storage/images/posts/' . $sidebarRecentPosts->featured_image)); ?>"
...
<?php /**PATH D:\Semester 4\Pemrograman Web Lanjut\utsss\Laravel\resources\views/frontend/layouts/sidebar_recent_post.blade.php ENDPATH**/ ?>