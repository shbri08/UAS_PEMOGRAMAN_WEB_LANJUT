                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px; text-align:center">
                                            <form action="<?php echo e(route('author.posts.destroy', $posts->id)); ?>" method="POST"
                                                ...
                                                <div class="btn-group">
                                                    <a href="<?php echo e(route('posts.show', ['seotitle' => $posts->seotitle])); ?>" class="btn btn-primary">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Semester 4\Pemrograman Web Lanjut\UAS\Laravel\resources\views/frontend/author/posts/index.blade.php ENDPATH**/ ?>