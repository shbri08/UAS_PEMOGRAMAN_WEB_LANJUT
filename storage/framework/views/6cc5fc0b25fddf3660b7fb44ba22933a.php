                            ...
                            <div class="col">
                                <div class="card border-0 bg-light-subtle rounded-3 shadow">
                                    <a href="<?php echo e(route('posts.show', ['slug' => $latestPost->slug])); ?>">
                                        <?php if($latestPost->featured_image && Storage::exists('images/posts/' . $latestPost->featured_image)): ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Semester 4\Pemrograman Web Lanjut\utsss\Laravel\resources\views/frontend/posts/index.blade.php ENDPATH**/ ?>