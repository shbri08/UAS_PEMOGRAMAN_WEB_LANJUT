                ...
                <?php if(auth()->user()->hasRole('author')): ?>
                    <div class="dropdown text-end">
                        <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle"
                            ...
                            <?php if(Storage::exists('images/users/' . auth()->user()->profile_image)): ?>
...
<?php /**PATH D:\Semester 4\Pemrograman Web Lanjut\UTS\Laravel\lara-starter\resources\views/frontend/layouts/navigation.blade.php ENDPATH**/ ?>